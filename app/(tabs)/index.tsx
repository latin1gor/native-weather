import {Image, View, Text, SafeAreaView, TextInput, TouchableOpacity} from 'react-native';
...
export default function HomeScreen() {
    ...
    return (
        <View className="flex-1 relative">
            ...
            <Image blurRadius={10} source={require("../../assets/images/main-bg.jpg")}
            ...
            <SafeAreaView className="flex flex-1">
                <View style={{height: "7%"}} className={"mx-4 relative z-50"}>
                    <View
                        ...
                        <TouchableOpacity className={"rounded-full bg-white/30 p-3 m-1"}
                                          onPress={() => setShowSearch(prev => !prev)}><MagnifyingGlassIcon size={"25"}
